...
int main() {
    ...
    // as variáveis receberão os seus devidos valores
    ...
    // cálculos usados para definir os valores das variáveis densidade, PIB per capita e super poder
    ...
    // exibição dos valores escolhidos para cada variável
    ...
    printf ("***Comparação das cartas, primeira rodada***\n");
    ...
    scanf ("%d", &opcao1);
    // a comparação dos atributos, que foi feita com switch e if-else
    ...
    printf ("***Comparação das cartas, segunda rodada***\n");
    printf ("Escolha um número, de 1 a 6, para ver a comparação das cartas\n");
    printf ("Esse numero deve ser diferente do selecionado anteriormente\n");
    printf ("1 - Nome, 2 - População, 3 - Área, 4 - PIB, 5 - Pontos turísticos, 6 - Densidade demográfica\n");
    scanf ("%d", &opcao2);
    //comparação dos atributos para a segunda rodada, mas usando if-else para proibir que o jogador escolha a opção anterior

    if (opcao1 == opcao2) {
        printf ("Você escolheu o mesmo número!\n");
    } else { 
